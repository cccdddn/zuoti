...
Page({
  ...
  onLoad (params) {
    ...
    var that = this;
    https.chapter('Gateway/route?method=pingshifen.question.chapter&course_id=' + wx.getStorageSync('jiaoxue_addedCourse'), { subject: params.subject, type: params.type }).then((data) =>{
